-- @description query01 for PXF HBase use wrong PXF Profile case
...
--
-- m/(ERROR|WARNING):.*javax.servlet.ServletException: NoSuchObjectException.*/
...
--
-- end_matchsubs
SELECT * from wrong_profile_hbase_table ORDER BY recordkey;
