package com.pxf.automation.utils.exception;
...
import com.pxf.automation.utils.regex.RegexUtils;
...
public abstract class ExceptionUtils {
	...
	public static void validate(Reporter report, Exception thrown, Exception expected, boolean isRegex, boolean ignoreExceptionType)
		...
		if (!ignoreExceptionType) {
			reportMessage = "\n\nExpected exception: " + expected.getClass().getName() + "\n\nactual exception thrown: " + thrown.getClass()
					.getName() + "\n\n";
			if (!thrown.getClass().getName().equals(expected.getClass().getName())) {
