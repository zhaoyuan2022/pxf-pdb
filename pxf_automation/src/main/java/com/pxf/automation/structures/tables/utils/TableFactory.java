package com.pxf.automation.structures.tables.utils;
...
import com.pxf.automation.structures.tables.hive.HiveExternalTable;
...
public abstract class TableFactory {
    ...
    public static ReadableExternalTable getPxfHiveReadableTable(String tableName,
        ...
        if (useProfile) {
            ...
            exTable.setFragmenter("org.apache.hawq.pxf.plugins.hive.HiveDataFragmenter");
            exTable.setAccessor("org.apache.hawq.pxf.plugins.hive.HiveAccessor");
            exTable.setResolver("org.apache.hawq.pxf.plugins.hive.HiveResolver");
        }
    ...
    public static ReadableExternalTable getPxfHiveRcReadableTable(String tableName,
        ...
        if (useProfile) {
            ...
            exTable.setFragmenter("org.apache.hawq.pxf.plugins.hive.HiveInputFormatFragmenter");
            exTable.setAccessor("org.apache.hawq.pxf.plugins.hive.HiveRCFileAccessor");
            exTable.setResolver("org.apache.hawq.pxf.plugins.hive.HiveColumnarSerdeResolver");
        }
    ...
    public static ReadableExternalTable getPxfHiveOrcReadableTable(String tableName,
        ...
        if (useProfile) {
            ...
            exTable.setFragmenter("org.apache.hawq.pxf.plugins.hive.HiveInputFormatFragmenter");
            exTable.setAccessor("org.apache.hawq.pxf.plugins.hive.HiveORCFileAccessor");
            exTable.setResolver("org.apache.hawq.pxf.plugins.hive.HiveORCSerdeResolver");
        }
        exTable.setFormatter("pxfwritable_import");
    ...
    public static ReadableExternalTable getPxfHiveTextReadableTable(String tableName,
        ...
        if (useProfile) {
            ...
            exTable.setFragmenter("org.apache.hawq.pxf.plugins.hive.HiveInputFormatFragmenter");
            exTable.setAccessor("org.apache.hawq.pxf.plugins.hive.HiveLineBreakAccessor");
            exTable.setResolver("org.apache.hawq.pxf.plugins.hive.HiveStringPassResolver");
        }
        exTable.setDelimiter("E'\\x01'");
        exTable.setUserParameters(new String[] { "delimiter=\\x01" });
