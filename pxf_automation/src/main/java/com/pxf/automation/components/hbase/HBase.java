package com.pxf.automation.components.hbase;
...
import com.pxf.automation.components.common.BaseSystemObject;
import com.pxf.automation.components.common.IDbFunctionality;
import com.pxf.automation.structures.tables.hbase.HBaseTable;
import com.pxf.automation.utils.hbase.HBaseUtils;
...
public class HBase extends BaseSystemObject implements IDbFunctionality {
    ...
    @Override
    public void queryResults(com.pxf.automation.structures.tables.basic.Table table,
     ...
     * @throws Exception
     */
    public void loadBulk(com.pxf.automation.structures.tables.basic.Table table,
    ...
    @Override
    public void createTable(com.pxf.automation.structures.tables.basic.Table table)
            throws Exception {
    ...
    @Override
    public void dropTable(com.pxf.automation.structures.tables.basic.Table table,
    ...
    public void disableTable(com.pxf.automation.structures.tables.basic.Table table)
            throws Exception {
        ReportUtils.startLevel(report, getClass(),
    ...
    public void enableTable(com.pxf.automation.structures.tables.basic.Table table)
            throws Exception {
        ReportUtils.startLevel(report, getClass(),
    ...
    public void removeColumn(com.pxf.automation.structures.tables.basic.Table table,
    ...
    public void addColumn(com.pxf.automation.structures.tables.basic.Table table,
                          String[] columns) throws Exception {
    ...
    @Override
    public void insertData(com.pxf.automation.structures.tables.basic.Table source,
                           com.pxf.automation.structures.tables.basic.Table target)
            throws Exception {
    ...
    @Override
    public void createTableAndVerify(com.pxf.automation.structures.tables.basic.Table table)
            throws Exception {
    ...
    @Override
    public boolean checkTableExists(com.pxf.automation.structures.tables.basic.Table table)
            throws Exception {
    ...
    @Override
    public void grantReadOnTable(com.pxf.automation.structures.tables.basic.Table table,
                                 String user) throws Exception {
        this.grantPermissions(table, user, Action.READ);
    }

    @Override
    public void grantWriteOnTable(com.pxf.automation.structures.tables.basic.Table table,
                                  String user) throws Exception {
        this.grantPermissions(table, user, Action.WRITE);
    }

    public void grantCreateReadOnTable(com.pxf.automation.structures.tables.basic.Table table,
                                  String user) throws Exception {
    ...
    private void grantPermissions(com.pxf.automation.structures.tables.basic.Table table,
