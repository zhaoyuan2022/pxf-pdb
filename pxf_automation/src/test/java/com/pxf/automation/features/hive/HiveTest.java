...
public class HiveTest extends HiveBaseTest {
    ...
    public void partitionFilterPushDown() throws Exception {
        ...
        // Create HAWQ table without using profiles
    ...
    public void describeHiveTable() throws Exception {
        ...
        Assert.assertTrue(psqlOutput.contains("Hive views are not supported by HAWQ"));
    ...
    /**
     * Make sure HAWQ is functional optimized profile for heterogeneous tables.
