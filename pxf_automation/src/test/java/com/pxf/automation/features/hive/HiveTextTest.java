...
import com.pxf.automation.utils.system.PGModeEnum;
import com.pxf.automation.utils.system.SystemUtils;
...
public class HiveTextTest extends HiveBaseTest {
    ...
    public void mismatchedTypes() throws Exception {
        ...
        // Hive column is SMALLINT, expected HAWQ type is SMALLINT(int2), but actual is INTEGER(int4)
        String unsupported = "org.apache.hawq.pxf.api.UnsupportedTypeException: Invalid definition for column ";
        ...
        try {
            ...
            ExceptionUtils.validate(null, e,
                    new Exception(unsupported + "tn: expected HAWQ type SMALLINT, actual HAWQ type INTEGER"),
                    true, true);
        }
    ...
    public void partitionFilterPushDown() throws Exception {
        ...
        exTable.setFragmenter("com.pxf.automation.testplugin.HiveDataFragmenterWithFilter");
