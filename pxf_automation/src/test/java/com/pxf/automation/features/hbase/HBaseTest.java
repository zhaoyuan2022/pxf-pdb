...
import com.pxf.automation.datapreparer.hbase.HBaseDataPreparer;
import com.pxf.automation.datapreparer.hbase.HBaseLongQualifierDataPreparer;
...
public class HBaseTest extends BaseFeature {
    ...
    private String testPackage = "com.pxf.automation.testplugin.";
    ...
    private void createAndQueryPxfHawqFilterTable(HBaseTable hbaseTable, String[] fields,
        ...
        externalTableFilterPrinter.setFragmenter("org.apache.hawq.pxf.plugins.hbase.HBaseDataFragmenter");
        externalTableFilterPrinter.setAccessor(testPackage + "FilterPrinterAccessor");
        externalTableFilterPrinter.setResolver("org.apache.hawq.pxf.plugins.hbase.HBaseResolver");
    ...
    private void createPxfHBaseFilterTable(String filter, HBaseTable hbaseTable, String[] fields) throws Exception {
        ...
        externalTableHBaseWithFilter.setFragmenter("org.apache.hawq.pxf.plugins.hbase.HBaseDataFragmenter");
        externalTableHBaseWithFilter.setAccessor(testPackage + "HBaseAccessorWithFilter");
        externalTableHBaseWithFilter.setResolver("org.apache.hawq.pxf.plugins.hbase.HBaseResolver");
