...
import com.pxf.automation.datapreparer.CustomSequencePreparer;
...
public class HdfsAnalyzeTest extends BaseFeature {
    ...
    String schemaPackage = "com.pxf.automation.dataschema.";
    ...
    /**
     * Prepares all components and all data flow (Hdfs to HAWQ)
     */
    @Override
    ...
    public void analyzeOnSequenceSmall() throws Exception {
        ...
        exTable.setAccessor("org.apache.hawq.pxf.plugins.hdfs.SequenceFileAccessor");
        exTable.setResolver("org.apache.hawq.pxf.plugins.hdfs.WritableResolver");
