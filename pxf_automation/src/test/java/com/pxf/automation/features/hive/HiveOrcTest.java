...
public class HiveOrcTest extends HiveBaseTest {
    ...
    public void aggregateQueries() throws Exception {
        ...
        exTable.setAccessor("org.apache.hawq.pxf.plugins.hive.HiveORCAccessor");
        exTable.setFragmenter("com.pxf.automation.testplugin.MultipleHiveFragmentsPerFileFragmenter");
