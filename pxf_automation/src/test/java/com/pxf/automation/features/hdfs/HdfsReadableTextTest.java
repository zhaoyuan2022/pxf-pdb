package com.pxf.automation.features.hdfs;
...
import com.pxf.automation.structures.tables.pxf.ErrorTable;
...
import com.pxf.automation.datapreparer.CustomTextPreparer;
import com.pxf.automation.datapreparer.QuotedLineTextPreparer;
...
public class HdfsReadableTextTest extends BaseFeature {
    ...
    /**
     * Prepare all components and all data flow (Hdfs to HAWQ)
     */
    @Override
    ...
    public void readMultiBlockedMultiLinedCsv() throws Exception {
        ...
        exTable.setFragmenter("org.apache.hawq.pxf.plugins.hdfs.HdfsDataFragmenter");
        exTable.setAccessor("org.apache.hawq.pxf.plugins.hdfs.QuotedLineBreakAccessor");
        exTable.setResolver("org.apache.hawq.pxf.plugins.hdfs.StringPassResolver");
        exTable.setHost(pxfHost);
        exTable.setPort(pxfPort);
        hawq.createTableAndVerify(exTable);
