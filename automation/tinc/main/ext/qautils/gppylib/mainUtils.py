...
from qautils.gppylib.commands import gp, unix
from qautils.gppylib.commands.base import ExecutionError
from qautils.gppylib.system import configurationInterface, configurationImplGpdb, fileSystemInterface, \
...
class YamlOptions:
    ...
    def __init__(self, target):
        ...
        self.parser = OptionParser( description=self.y['Description'], version='%prog version $Revision: #2 $')
