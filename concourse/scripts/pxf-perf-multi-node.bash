...
EOF
    ...
    gpssh -u gpadmin -f /tmp/segment_hosts -v -s -e \
      'source /usr/local/greenplum-db-devel/greenplum_path.sh && mv $GPHOME/pxf/conf/core-site.xml $GPHOME/pxf/conf/core-site.xml.back && cp /tmp/core-site-patch.xml $GPHOME/pxf/conf/core-site.xml && $GPHOME/pxf/bin/pxf restart'
