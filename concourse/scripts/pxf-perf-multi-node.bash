...
EOF
    ...
    gpssh -u gpadmin -f /tmp/segment_hosts -v -s -e \
      'export MASTER_DATA_DIRECTORY=/data/gpdata/master/gpseg-1 && source /usr/local/greenplum-db-devel/greenplum_path.sh && mv $GPHOME/pxf/conf/core-site.xml $GPHOME/pxf/conf/core-site.xml.back && cp /tmp/core-site-patch.xml $GPHOME/pxf/conf/core-site.xml && gpstop -u'
...
EOF
    ...
    # Restore core-site
    gpssh -u gpadmin -f /tmp/segment_hosts -v -s -e \
      'export MASTER_DATA_DIRECTORY=/data/gpdata/master/gpseg-1 && source /usr/local/greenplum-db-devel/greenplum_path.sh && mv $GPHOME/pxf/conf/core-site.xml $GPHOME/pxf/conf/core-site.xml.s3 && cp $GPHOME/pxf/conf/core-site.xml.back $GPHOME/pxf/conf/core-site.xml && gpstop -u'
}
