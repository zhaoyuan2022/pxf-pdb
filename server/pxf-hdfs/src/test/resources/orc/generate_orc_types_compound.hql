...
STORED AS TEXTFILE
LOCATION '/tmp/orc_types/csv_compound';
...
INSERT OVERWRITE local directory './orc_types_compound' row format delimited fields terminated by ',' SELECT * FROM orc_types;
