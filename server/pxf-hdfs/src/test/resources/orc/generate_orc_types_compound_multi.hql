...
STORED AS TEXTFILE
LOCATION '/tmp/orc_types/csv_compound_multi';
...
INSERT INTO orc_types SELECT 2, array(array(false, true), array(boolean(1), boolean(0))), array(collect_list(tinyint(null))), array(array(2,3), array(int(null)), array(4,5)), array(array(bigint(null))), array(collect_list(float(null))), array(array(double(1.0))), array(array('this is a string with "special" characters'), array('this is a string without')), array(collect_list(binary(null))), array(array(cast('this is exactly' as char(15))), array(cast(' fifteen chars.' as char(15)))), array(array(cast('this is exactly' as varchar(15))), array(cast(' fifteen chars.' as varchar(15)))) FROM foo;
...
INSERT INTO orc_types SELECT 4, array(array(boolean(null))), array(array(tinyint(10), tinyint(20))), array(array(7, null), array(8)), array(array(bigint(-9223372036854775808), bigint(0))), array(array(float(2.3)), array(float(4.5))), array(array(double(null))), array(collect_list(string(null))), array(array(binary(null), unhex('5c22'))), array(array(cast(null as char(15)))), array(array(cast(null as varchar(15)))) FROM foo;

INSERT INTO orc_types SELECT 5, array(array(true, false)), array(array(tinyint(null))), array(collect_list(int(null))), array(array(bigint(null)), array(bigint(9223372036854775807))), array(array(float(6.7), float(-8)), array(float(null))), array(collect_list(double(null))), array(array(string(null))), array(array(unhex('5C5C5C'), unhex('5B48495D')), array(binary(null))), array(array(cast('specials \\ "' as char(15))), array(cast(null as char(15)))), array(array(cast('specials \\ "' as varchar(15))), array(cast(null as varchar(15)))) FROM foo;

INSERT INTO orc_types SELECT 6, array(array(true, false), array(boolean(null))), array(array(tinyint(0), tinyint(127)), array(tinyint(null))), array(array(int(2147483647), int(-2147483648))), array(array(bigint(1), null), array(bigint(300))), array(array(float(0.00000000000001))), array(array(null, double(8.431)), array(double(-1.56), double(0.001))), array(array('this is a test string with \\ and "', null)), array(array(unhex('313233')), array(unhex('343536'))), array(array(cast('test string' as char(15)), cast(null as char(15))), array(cast('2 whitespace  ' as char(15)), cast('no whitespace' as char(15)))), array(array(cast('test string' as varchar(15)), cast(null as varchar(15))), array(cast('2 whitespace  ' as varchar(15)), cast('no whitespace' as varchar(15)))) FROM foo;

INSERT OVERWRITE local directory './orc_types_compound_multi' row format delimited fields terminated by ',' SELECT * FROM orc_types;
